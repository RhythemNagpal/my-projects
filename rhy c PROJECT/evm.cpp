...
int showmouseptr(); // FUNCTION TO SHOW POINTER
int restrictmouseptr(int,int,int,int); // FUNCTION TO RESTRICT POINTER
int getmousepos(int *,int *,int *); // TO GET POINTER POSITION
int format(); // FUNCTION TO DRAW LAYOUT OF EVM
int graph(); // FUNCTION TO DISPLAY RESULT AS GRAPH
int welcome(); // FUNCTION TO DISPLAY WELCOME MESSAGE
int boundry();
